...
var G__29939 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__29939,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__29939;
}
});
...
var G__29946 = (i__4731__auto___29945 + (1));
i__4731__auto___29945 = G__29946;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq29941){
var G__29942 = cljs.core.first.call(null,seq29941);
var seq29941__$1 = cljs.core.next.call(null,seq29941);
var G__29943 = cljs.core.first.call(null,seq29941__$1);
var seq29941__$2 = cljs.core.next.call(null,seq29941__$1);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__29942,G__29943,seq29941__$2);
});
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__29948,map__29948__$1,file,line,column){
return (function (p1__29947_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__29947_SHARP_));
});})(map__29948,map__29948__$1,file,line,column))
...
var temp__5457__auto___29950 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___29950)){
var message_29951 = temp__5457__auto___29950;
cljs.core.println.call(null,message_29951);
} else {
}
...
var temp__5457__auto___29952 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___29952)){
var message_29953 = temp__5457__auto___29952;
cljs.core.println.call(null,message_29953);
} else {
}
...
var output_dir__$1 = (function (){var G__29954 = output_dir;
if((!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/")))){
return [G__29954,"/"].join('');
} else {
return G__29954;
}
})();
...
var G__29956 = exception.stack;
var G__29956__$1 = (((G__29956 == null))?null:clojure.string.split_lines.call(null,G__29956));
var G__29956__$2 = (((G__29956__$1 == null))?null:cljs.core.get.call(null,G__29956__$1,depth));
if((G__29956__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__29956__$2);
}
} else {
...
var vec__29957 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__29957,(0),null);
var column = cljs.core.nth.call(null,vec__29957,(1),null);
var vec__29960 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__29960,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__29960,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__29960,(2),null);
...
var m__$1 = (function (){var G__29963 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__29967 = (function (){var G__29966 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__29966);
} else {
return G__29966;
}
})();
...
return cljs.core.vary_meta.call(null,G__29968,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__29976 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__29976,(0),null);
var types = vec__29976;
...
return cljs.core.map.call(null,(function (p__29981){
var vec__29982 = p__29981;
var ns = cljs.core.nth.call(null,vec__29982,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__29982,(1),null);
return ((function (vec__29982,ns,vars__$1){
return (function (){
...
var G__29985 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__29985,G__29985__$1,env,once_fixtures,each_fixtures,vec__29982,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__29985,G__29985__$1,env,once_fixtures,each_fixtures,vec__29982,ns,vars__$1){
return (function (){
var seq__29986 = cljs.core.seq.call(null,vars__$1);
var chunk__29987 = null;
var count__29988 = (0);
var i__29989 = (0);
while(true){
if((i__29989 < count__29988)){
var v = cljs.core._nth.call(null,chunk__29987,i__29989);
var temp__5457__auto___30014 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___30014)){
var t_30015 = temp__5457__auto___30014;
each_fixture_fn.call(null,((function (seq__29986,chunk__29987,count__29988,i__29989,t_30015,temp__5457__auto___30014,v,each_fixture_fn,G__29985,G__29985__$1,env,once_fixtures,each_fixtures,vec__29982,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_30015)));
});})(seq__29986,chunk__29987,count__29988,i__29989,t_30015,temp__5457__auto___30014,v,each_fixture_fn,G__29985,G__29985__$1,env,once_fixtures,each_fixtures,vec__29982,ns,vars__$1))
);
} else {
}


var G__30016 = seq__29986;
var G__30017 = chunk__29987;
var G__30018 = count__29988;
var G__30019 = (i__29989 + (1));
seq__29986 = G__30016;
chunk__29987 = G__30017;
count__29988 = G__30018;
i__29989 = G__30019;
continue;
} else {
var temp__5457__auto__ = cljs.core.seq.call(null,seq__29986);
if(temp__5457__auto__){
var seq__29986__$1 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__29986__$1)){
var c__4550__auto__ = cljs.core.chunk_first.call(null,seq__29986__$1);
var G__30020 = cljs.core.chunk_rest.call(null,seq__29986__$1);
var G__30021 = c__4550__auto__;
var G__30022 = cljs.core.count.call(null,c__4550__auto__);
var G__30023 = (0);
seq__29986 = G__30020;
chunk__29987 = G__30021;
count__29988 = G__30022;
i__29989 = G__30023;
continue;
} else {
var v = cljs.core.first.call(null,seq__29986__$1);
var temp__5457__auto___30024__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___30024__$1)){
var t_30025 = temp__5457__auto___30024__$1;
each_fixture_fn.call(null,((function (seq__29986,chunk__29987,count__29988,i__29989,t_30025,temp__5457__auto___30024__$1,v,seq__29986__$1,temp__5457__auto__,each_fixture_fn,G__29985,G__29985__$1,env,once_fixtures,each_fixtures,vec__29982,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_30025)));
});})(seq__29986,chunk__29987,count__29988,i__29989,t_30025,temp__5457__auto___30024__$1,v,seq__29986__$1,temp__5457__auto__,each_fixture_fn,G__29985,G__29985__$1,env,once_fixtures,each_fixtures,vec__29982,ns,vars__$1))
);
} else {
}


var G__30026 = cljs.core.next.call(null,seq__29986__$1);
var G__30027 = null;
var G__30028 = (0);
var G__30029 = (0);
seq__29986 = G__30026;
chunk__29987 = G__30027;
count__29988 = G__30028;
i__29989 = G__30029;
continue;
}
} else {
...
});})(each_fixture_fn,G__29985,G__29985__$1,env,once_fixtures,each_fixtures,vec__29982,ns,vars__$1))
);
});})(each_fixture_fn,G__29985,G__29985__$1,env,once_fixtures,each_fixtures,vec__29982,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__29985__$1)].join('')));

}
})());
});
;})(vec__29982,ns,vars__$1))
