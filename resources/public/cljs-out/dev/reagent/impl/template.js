...
var G__17305 = o;
(G__17305[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__17307__i < G__17307__a.length) {G__17307__a[G__17307__i] = arguments[G__17307__i + 0]; ++G__17307__i;}
  args = new cljs.core.IndexedSeq(G__17307__a,0,null);
} 
...
var G__17309 = o;
(G__17309[reagent.impl.template.cached_custom_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__17311__i < G__17311__a.length) {G__17311__a[G__17311__i] = arguments[G__17311__i + 0]; ++G__17311__i;}
  args = new cljs.core.IndexedSeq(G__17311__a,0,null);
} 
...
var G__17314 = props;
var G__17314__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__17314,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__17314);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__17314__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__17315){
...
var props = map__17316__$1;
var class$ = cljs.core.get.call(null,map__17316__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_.call(null,class$)){
return cljs.core.assoc.call(null,props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",cljs.core.keep.call(null,((function (map__17316,map__17316__$1,props,class$){
return (function (c){
...
});})(map__17316,map__17316__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__17318){
...
var on_write = cljs.core.get.call(null,map__17319__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__17319,map__17319__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__17319,map__17319__$1,on_write))
);
} else {
...
var G__17322 = jsprops;
(G__17322["defaultValue"] = value);

(G__17322["onChange"] = ((function (G__17322,v,value,on_change){
return (function (p1__17321_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__17321_SHARP_);
});})(G__17322,v,value,on_change))
);
...
var vec__17325 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__17325,(0),null);
var id = cljs.core.nth.call(null,vec__17325,(1),null);
var class$ = cljs.core.nth.call(null,vec__17325,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___17329 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5461__auto___17329 == null)){
} else {
var key_17330 = temp__5461__auto___17329;
(jsprops["key"] = key_17330);
}
...
var temp__5461__auto___17331 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5461__auto___17331 == null)){
} else {
var key_17332 = temp__5461__auto___17331;
reagent.impl.template.oset.call(null,jsprops,"key",key_17332);
}
...
var G__17333 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__17333["name"] = c);
...
var len__4730__auto___17339 = arguments.length;
var i__4731__auto___17340 = (0);
while(true){
if((i__4731__auto___17340 < len__4730__auto___17339)){
args__4736__auto__.push((arguments[i__4731__auto___17340]));

var G__17341 = (i__4731__auto___17340 + (1));
i__4731__auto___17340 = G__17341;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq17337){
var G__17338 = cljs.core.first.call(null,seq17337);
var seq17337__$1 = cljs.core.next.call(null,seq17337);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__17338,seq17337__$1);
});
...
break;
default:
var G__17344 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__17344;
continue;
...
var n__4607__auto___17346 = a.length;
var i_17347 = (0);
while(true){
if((i_17347 < n__4607__auto___17346)){
(a[i_17347] = reagent.impl.template.as_element.call(null,(a[i_17347])));
...
var a = cljs.core.into_array.call(null,s);
var n__4607__auto___17349 = a.length;
var i_17350 = (0);
while(true){
if((i_17350 < n__4607__auto___17349)){
var val_17351 = (a[i_17350]);
if(((cljs.core.vector_QMARK_.call(null,val_17351)) && ((reagent.impl.template.key_from_vec.call(null,val_17351) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_17350] = reagent.impl.template.as_element.call(null,val_17351));

var G__17352 = (i_17350 + (1));
i_17350 = G__17352;
continue;
} else {
}
...
var ctx = ({});
var vec__17353 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__17353,(0),null);
var derefed = cljs.core.nth.call(null,vec__17353,(1),null);
...
var G__17356 = (cljs.core.count.call(null,argv) - first_child);
switch (G__17356) {
case (0):
...
break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__17356){
