...
var with_let33087 = reagent.ratom.with_let_values.call(null,new cljs.core.Keyword(null,"with-let33087","with-let33087",-756849717));
var temp__5461__auto___33089 = reagent.ratom._STAR_ratom_context_STAR_;
if((temp__5461__auto___33089 == null)){
} else {
var c__15014__auto___33090 = temp__5461__auto___33089;
if((with_let33087.generation === c__15014__auto___33090.ratomGeneration)){
...
with_let33087.generation = c__15014__auto___33090.ratomGeneration;
}


var init33088 = (with_let33087.length === (0));
var color = ((init33088)?(with_let33087[(0)] = reagent.core.atom.call(null,"#3a3a3a")):(with_let33087[(0)]));
var res__15015__auto__ = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"text","text",-1790561697),cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword(null,"y","y",-1757859776),new cljs.core.Keyword(null,"text-anchor","text-anchor",585613696),new cljs.core.Keyword(null,"font-size","font-size",-1847940346),new cljs.core.Keyword(null,"on-mouse-out","on-mouse-out",643448647),new cljs.core.Keyword(null,"fill","fill",883462889),new cljs.core.Keyword(null,"on-click","on-click",1632826543),new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.Keyword(null,"dominant-baseline","dominant-baseline",609259826),new cljs.core.Keyword(null,"on-mouse-over","on-mouse-over",-858472552),new cljs.core.Keyword(null,"x","x",2099068185)],["50%","middle",(0.15 * cljs.core.deref.call(null,re_frame.core.subscribe.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"size","size",1098693007)], null)))),((function (init33088,color,with_let33087){
return (function (e){
return cljs.core.reset_BANG_.call(null,color,"#3a3a3a");
});})(init33088,color,with_let33087))
,cljs.core.deref.call(null,color),((function (init33088,color,with_let33087){
return (function (){
...
,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"transition","transition",765692007),"all 0.5s linear"], null),"middle",((function (init33088,color,with_let33087){
return (function (e){
...
return (function flood_it$view$board_$_iter__33091(s__33092){
return (new cljs.core.LazySeq(null,((function (size){
return (function (){
var s__33092__$1 = s__33092;
while(true){
var temp__5457__auto__ = cljs.core.seq.call(null,s__33092__$1);
if(temp__5457__auto__){
var xs__6012__auto__ = temp__5457__auto__;
var i = cljs.core.first.call(null,xs__6012__auto__);
var iterys__4519__auto__ = ((function (s__33092__$1,i,xs__6012__auto__,temp__5457__auto__,size){
return (function flood_it$view$board_$_iter__33091_$_iter__33093(s__33094){
return (new cljs.core.LazySeq(null,((function (s__33092__$1,i,xs__6012__auto__,temp__5457__auto__,size){
return (function (){
var s__33094__$1 = s__33094;
while(true){
var temp__5457__auto____$1 = cljs.core.seq.call(null,s__33094__$1);
if(temp__5457__auto____$1){
var s__33094__$2 = temp__5457__auto____$1;
if(cljs.core.chunked_seq_QMARK_.call(null,s__33094__$2)){
var c__4521__auto__ = cljs.core.chunk_first.call(null,s__33094__$2);
var size__4522__auto__ = cljs.core.count.call(null,c__4521__auto__);
var b__33096 = cljs.core.chunk_buffer.call(null,size__4522__auto__);
if((function (){var i__33095 = (0);
while(true){
if((i__33095 < size__4522__auto__)){
var j = cljs.core._nth.call(null,c__4521__auto__,i__33095);
cljs.core.chunk_append.call(null,b__33096,cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [flood_it.view.square,i,j], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [i,j], null)], null)));

var G__33097 = (i__33095 + (1));
i__33095 = G__33097;
continue;
} else {
return true;
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__33096),flood_it$view$board_$_iter__33091_$_iter__33093.call(null,cljs.core.chunk_rest.call(null,s__33094__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__33096),null);
}
} else {
var j = cljs.core.first.call(null,s__33094__$2);
return cljs.core.cons.call(null,cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [flood_it.view.square,i,j], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [i,j], null)], null)),flood_it$view$board_$_iter__33091_$_iter__33093.call(null,cljs.core.rest.call(null,s__33094__$2)));
}
} else {
return null;
}
...
});})(s__33092__$1,i,xs__6012__auto__,temp__5457__auto__,size))
,null,null));
});})(s__33092__$1,i,xs__6012__auto__,temp__5457__auto__,size))
;
var fs__4520__auto__ = cljs.core.seq.call(null,iterys__4519__auto__.call(null,cljs.core.range.call(null,size)));
if(fs__4520__auto__){
return cljs.core.concat.call(null,fs__4520__auto__,flood_it$view$board_$_iter__33091.call(null,cljs.core.rest.call(null,s__33092__$1)));
} else {
var G__33098 = cljs.core.rest.call(null,s__33092__$1);
s__33092__$1 = G__33098;
continue;
}
} else {
return null;
