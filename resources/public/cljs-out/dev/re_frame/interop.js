...
return [(function (){var pred__17559 = cljs.core.instance_QMARK_;
var expr__17560 = reactive_val;
if(cljs.core.truth_(pred__17559.call(null,reagent.ratom.RAtom,expr__17560))){
return "ra";
} else {
if(cljs.core.truth_(pred__17559.call(null,reagent.ratom.RCursor,expr__17560))){
return "rc";
} else {
if(cljs.core.truth_(pred__17559.call(null,reagent.ratom.Reaction,expr__17560))){
return "rx";
} else {
if(cljs.core.truth_(pred__17559.call(null,reagent.ratom.Track,expr__17560))){
return "tr";
} else {
return "other";
}
