...
var o21785 = temp__5455__auto__;
var temp__5455__auto____$1 = (o21785["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o21786 = temp__5455__auto____$1;
return (o21786["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__21602__auto__ = f;
return (o__21602__auto__["toString"]).call(o__21602__auto__);
} else {
return "";
}
}catch (e21787){var _ = e21787;
return "";
}});
...
try{var o__21602__auto___21789 = t;
(o__21602__auto___21789["cljs$lang$ctorPrWriter"]).call(o__21602__auto___21789,t,writer);
}catch (e21788){var __21790 = e21788;
}
...
var char_code = (function (){var o__21602__auto__ = (new String(char$));
return (o__21602__auto__["charCodeAt"]).call(o__21602__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__21602__auto__ = String;
return (o__21602__auto__["fromCharCode"]).call(o__21602__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__21791 = num_code;
switch (G__21791) {
case (1):
return (185);
...
var o__21602__auto__ = String;
return (o__21602__auto__["fromCharCode"]).call(o__21602__auto__,superscript_code);
});
/**
...
}catch (e21793){var _e__21609__auto__ = e21793;
return false;
}})())){
...
var vec__21794 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__21794,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o21797 = temp__5455__auto__;
var temp__5455__auto____$1 = (o21797["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o21798 = temp__5455__auto____$1;
return (o21798["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4730__auto___21805 = arguments.length;
var i__4731__auto___21806 = (0);
while(true){
if((i__4731__auto___21806 < len__4730__auto___21805)){
args__4736__auto__.push((arguments[i__4731__auto___21806]));

var G__21807 = (i__4731__auto___21806 + (1));
i__4731__auto___21806 = G__21807;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__21801){
var vec__21802 = p__21801;
var ns_detector = cljs.core.nth.call(null,vec__21802,(0),null);
...
var G__21808 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__21809 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__21808;
remaining_tokens = G__21809;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq21799){
var G__21800 = cljs.core.first.call(null,seq21799);
var seq21799__$1 = cljs.core.next.call(null,seq21799);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__21800,seq21799__$1);
});
...
var vec__21813 = cljs.core.split_with.call(null,(function (p1__21812_SHARP_){
return cljs.core.not_EQ_.call(null,p1__21812_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__21813,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__21813,(1),null);
...
var vec__21819 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__21819,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__21819,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__21822 = cljs.core.rest.call(null,remaining_tokens);
var G__21823 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__21822;
name_tokens = G__21823;
continue;
} else {
...
var vec__21826 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__21826,(0),null);
var arity = cljs.core.nth.call(null,vec__21826,(1),null);
var vec__21829 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__21829,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__21829,(1),null);
var vec__21832 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__21832,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__21832,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__21832,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__21832,(3),null);
...
var vec__21838 = result;
var munged_ns = cljs.core.nth.call(null,vec__21838,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__21838,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__21838,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__21838,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__21838,(4),null);
var arity = cljs.core.nth.call(null,vec__21838,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__21842 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__21842,(0),null);
var args = cljs.core.nth.call(null,vec__21842,(1),null);
var vec__21845 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__21845,(0),null);
var name = cljs.core.nth.call(null,vec__21845,(1),null);
...
var G__21848 = (arity + (1));
var G__21849 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__21850){
var vec__21851 = p__21850;
var arity = cljs.core.nth.call(null,vec__21851,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__21851,(1),null);
...
return cljs.core.get.call(null,arities,p1__21854_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__21855_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__21858){
var vec__21859 = p__21858;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__21859,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq21856){
var G__21857 = cljs.core.first.call(null,seq21856);
var seq21856__$1 = cljs.core.next.call(null,seq21856);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__21857,seq21856__$1);
});
...
var G__21865 = arg;
var G__21865__$1 = (((G__21865 instanceof cljs.core.Keyword))?G__21865.fqn:null);
switch (G__21865__$1) {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__21867__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__21867__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__21867__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__21867__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__21868 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__21868,(0),null);
var fn_name = cljs.core.nth.call(null,vec__21868,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__21868,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__21868,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__21868,(4),null);
var arity = cljs.core.nth.call(null,vec__21868,(5),null);
...
var o__21602__auto__ = f;
return (o__21602__auto__["getBasis"]).call(o__21602__auto__);
});
/**
...
}catch (e21872){var _e__21609__auto__ = e21872;
...
var G__21873 = (obj[cljs.core.first.call(null,path)]);
var G__21874 = cljs.core.rest.call(null,path);
obj = G__21873;
path = G__21874;
continue;
} else {
...
return (function (accum,p__21875){
var vec__21876 = p__21875;
var bit = cljs.core.nth.call(null,vec__21876,(0),null);
var protocol = cljs.core.nth.call(null,vec__21876,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__21879){
var vec__21880 = p__21879;
var ns = cljs.core.nth.call(null,vec__21880,(0),null);
var name = cljs.core.nth.call(null,vec__21880,(1),null);
var selector = cljs.core.nth.call(null,vec__21880,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__21885,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__21885,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__21885,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__21883_SHARP_){
return (obj[cljs.core.first.call(null,p1__21883_SHARP_)]);
});})(name,sorted_matches,vec__21885,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
