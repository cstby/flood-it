...
var G__22361 = devtools.prefs.pref.call(null,v);
v = G__22361;
continue;
} else {
return v;
...
}catch (e22364){var _e__21609__auto__ = e22364;
return false;
}})();
...
}catch (e22368){var _e__21609__auto__ = e22368;
return false;
}})();
...
}catch (e22370){var _e__21609__auto__ = e22370;
return false;
}}
}
});
...
var vec__22372 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__22372,(0),null);
var name = cljs.core.nth.call(null,vec__22372,(1),null);
...
return cljs.core.some.call(null,(function (p1__22375_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__22375_SHARP_);
}),template);
});
